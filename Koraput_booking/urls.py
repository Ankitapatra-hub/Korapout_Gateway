"""
URL configuration for Koraput_booking project.
...
urlpatterns = [
    ...
    path('', include('useraccount.urls')),  # your login/register routes
    path('api/', include('planner.urls')),  # your planner routes
